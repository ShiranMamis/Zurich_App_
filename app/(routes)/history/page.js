...
export default function page() {
  ...
  function getData(page) {
    ...
    axios
      .get(`/priceoffers/history?page=${page ? page : currentPage}`, {
        params: { count },
      })
      .then((res) => {
        ...
        console.log(res.data.data.last_page, currentPage);
  ...
  function handleSearch(e, page) {
    ...
    axios
      .get(`priceoffers/searchHistory?page=${page ? page : currentPage}`, {
